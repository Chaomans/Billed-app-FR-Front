        ...
        <div class="form-newbill-container content-inner">
          <form data-testid="form-new-bill">
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <input required type="file" class="form-control blue-border" data-testid="file" accept=".png,.jpeg,.jpg"/>
                    <div class="invalid-feedback">
                      Le fichier doit être de type <b>PNG</b>, <b>JPG</b> ou <b>JPEG</b>.
                    </div>
                  </div>
                </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="col-half">
                  <button type="submit" id='btn-send-bill' class="btn btn-primary" data-testid="submit">Envoyer</button>
                </div>
              </div>
            </div>
          </form>
